  ...
  },
  {
    ...
    text: {
      cs: 'OVLÁDÁNÍ ZBRANÍ — každé tlačítko dělá něco jiného:\n'
        + '• SALVA 2 / SALVA 4 / PLNÁ — odpal 2, 4, nebo všech šachet boku\n'
        ...
        + '• ŘÍZENÉ / +RUŠIČKA — „vystřel a zapomeň" / raketa se obětuje jako rušička\n'
      ...
      en: 'WEAPON CONTROLS — every button does something different:\n'
        + '• VOLLEY 2 / VOLLEY 4 / FULL — launch 2, 4, or every tube on the broadside\n'
        ...
        + '• GUIDED / +JAMMER — fire-and-forget / one missile sacrifices itself as a jammer\n'
